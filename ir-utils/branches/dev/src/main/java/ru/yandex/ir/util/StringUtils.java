...
public final class StringUtils {
    ...
    private static String[][] HTML_ESCAPE = new String[][] {{"amp;","&"}, {"nbsp;", " "}, {"quot;", "\""}};    
    
    private static String normalizeHtml(String string) {
    	for(String[] r : HTML_ESCAPE) {
    		string.replaceAll(r[0], r[1]);
    	}
    	return string;
    }
