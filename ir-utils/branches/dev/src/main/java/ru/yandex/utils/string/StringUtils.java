...
public final class StringUtils {
    public static final String DELIMITERS = " @\"\t\n\r,.:;()/-<>'&_∞[]≠ЦЧ`©Ѓ±ґЈСТВУФДЖЗХЕЙЛИєЩ+ЂїђІ§¶\u007F\u001A\u00A0";
    ...
    public static final String SEARCH_DELIMITERS = ". ~@#*%^$\"\t\n\r:;+,?!()\\/<>'&_|{}∞[]`СЃЩЂї-≠ЦЧИХУТФ=±І?ЈД<>Е" + (char) 160;    
    ...
    public static String normalize(String string) {
        ...
        return normalizeRus2En(normalizeToNumeric(sb.toString().toLowerCase()));
    }
    ...
    public static String notebookNormalize(String string) {
        ...
        string = replaceCommasInRegion(string, "([^\\.,&&[\\D]])([0-9]+),([0-9]+)([^\\.,&&[\\D]])");
