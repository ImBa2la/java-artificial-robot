...
//			UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel");
	...
	private JButton getAddComplexCriteriaButton() {
		if (addComplexCriteriaButton == null) {
			addComplexCriteriaButton = new JButton(new ImageIcon(this.getClass().getResource("/AddCCriteria.gif")));
	...
	private JButton getAddSingleCriteriaButton() {
		if (addSingleCriteriaButton == null) {
			addSingleCriteriaButton = new JButton(new ImageIcon(this.getClass().getResource("/AddSCriteria.gif")));
	...
	private JButton getRemoveCriteriaButton() {
		if (removeCriteriaButton == null) {
			removeCriteriaButton = new JButton(new ImageIcon(this.getClass().getResource("/DelCriteria.gif")));
